...
```mermaid
%%{init: {"theme":"base","themeVariables":{"background":"#ffffff","primaryColor":"#f8fafc","primaryTextColor":"#111827","primaryBorderColor":"#64748b","lineColor":"#475569","secondaryColor":"#eef2ff","tertiaryColor":"#f0fdf4","fontFamily":"Inter, Arial, sans-serif"}}}%%
flowchart LR
    A["1. Long build<br/>T_TS −20 to −9 mo<br/>Estimate: 6–12+ mo<br/>Work 3/5 · Complexity 3/5<br/>Medical AI: 4/5"]
    B["2. Qualification cliff<br/>T_TS −9 to −3 mo<br/>Estimate: 3–6 mo<br/>Work 4/5 · Complexity 5/5<br/>MEDICAL AI COMPLEXITY PEAK"]
    C["3. Round assembly<br/>T_TS −8 to −3 wk<br/>Estimate: 2–5 wk<br/>Work 4/5 · Complexity 4/5"]
    D["4. Active investor sprint<br/>T_TS −6 wk to T_TS<br/>Estimate: 2–6 wk<br/>Work 5/5 · Complexity 4/5<br/>ACUTE WORKLOAD PEAK"]
    E["5. Diligence + close<br/>T_TS to T_CLOSE<br/>Observed guide: 6–8 wk [03]<br/>Work 4/5 · Complexity 4–5/5"]

    A --> B --> C --> D --> E

    B -. cumulative sleep/social debt .-> D
    D -. combined work + personal peak .-> E
```
...
```mermaid
%%{init: {"theme":"base","themeVariables":{"background":"#ffffff","primaryColor":"#f8fafc","primaryTextColor":"#111827","primaryBorderColor":"#64748b","lineColor":"#475569","secondaryColor":"#eff6ff","tertiaryColor":"#f0fdf4","fontFamily":"Inter, Arial, sans-serif"}}}%%
flowchart TB
    P["Model / product sprint<br/>Estimate: 1–2 wk"] --> V["Clinical / safety evaluation<br/>Estimate: 2–6 wk"]
    V --> I["Customer workflow + EHR integration<br/>Estimate: 2–12 wk"]
    I --> S["Security / privacy / procurement<br/>Estimate: 2–8 wk per customer"]
    S --> R["ROI + reference evidence<br/>Estimate: 2–4 wk to stabilize evidence"]
    R --> P

    V --> G["Regulatory / quality loop if applicable<br/>Estimate: 2–6 wk per major review cycle"]
    G --> P

    R --> F["Fundraise data room + investor story<br/>Estimate: 2–5 wk assembly"]
    F --> M["Parallel investor meetings<br/>Estimate: 2–6 wk"]
    M --> D["Confirmatory diligence + close<br/>Observed guide: 6–8 wk [03]"]

    D -. new commitments reset operating targets .-> P
```
...
```mermaid
%%{init: {"theme":"base","themeVariables":{"background":"#ffffff","primaryColor":"#ffffff","primaryTextColor":"#111827","primaryBorderColor":"#64748b","lineColor":"#475569","secondaryColor":"#eef2ff","tertiaryColor":"#fff7ed","fontFamily":"Inter, Arial, sans-serif"}}}%%
flowchart LR
    S1["T−20m…−9m<br/>Build<br/>Pressure 3/5"] -->
    S2["T−9m…−3m<br/>Qualification<br/>Medical AI complexity 5/5"] -->
    S3["T−8w…−3w<br/>Round assembly<br/>Pressure 4/5"] -->
    S4["T−6w…T_TS<br/>Investor sprint<br/>Work + personal 5/5"] -->
    S5["T_TS…T_CLOSE<br/>6–8w close [03]<br/>Pressure 4–5/5"]

    H["Cumulative personal debt:<br/>sleep ↓ · social time ↓ · exercise ↓ · holidays ↓ [06]"]
    H -. rises with duration .-> S2
    H -. highest exposure .-> S4
    H -. may persist .-> S5
```
...
```mermaid
%%{init: {"theme":"base","themeVariables":{"background":"#ffffff","primaryColor":"#f8fafc","primaryTextColor":"#111827","primaryBorderColor":"#64748b","lineColor":"#475569","secondaryColor":"#ecfeff","tertiaryColor":"#f0fdf4","fontFamily":"Inter, Arial, sans-serif"}}}%%
flowchart LR
    C0["Collate<br/>Jan 2025: emerges from stealth<br/>May 2025: first customer"] --> C1["Jun 2026: $95M round [09]<br/>Elapsed from stealth ≈17 mo<br/>Estimated pressure build: 6–12 mo"]

    A0["Assort<br/>Mar 2024: seed after ~45 investor approaches [10]"] --> A1["Sep 2025: prior round"] --> A2["Jun 2026: $120M round [10]<br/>3 rounds in 14 mo<br/>Estimated overlap peak: 6–9 mo"]

    T0["Triomics<br/>mid-2024: Series A"] --> T1["May 2026: $22M Series B [11]<br/>4× enterprise customers + 10× ARR in prior year<br/>Estimated proof sprint: 6–12 mo"]

    L0["Lotus<br/>May 2024: launch"] --> L1["Feb 2026: $35M Series A [12]<br/>Elapsed ≈21 mo<br/>Estimated clinical/regulatory build: 9–12 mo"]

    B0["Abridge<br/>Feb 2025: $250M"] --> B1["Jun 2025: $300M [13]<br/>≈4 mo between large rounds<br/>Compressed financing + scale window"]
```
